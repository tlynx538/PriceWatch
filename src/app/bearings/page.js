        ...
        <Container className='p-5'>
            <Paper className='p-3 mt-5' elevation={5}>
                <FormGroup>
                    ...
                    <InputLabel id="demo-simple-select-label">Choose Bearing Size</InputLabel>
                    <Select
                        ...
                        <MenuItem value={"6100"}>6100</MenuItem>
                        <MenuItem value={"6200"}>6200</MenuItem>
                    </Select>
                    </FormControl>
                    <FormControl fullWidth className="mt-3">
                        <InputLabel id="demo-simple-select-label-vendor">Choose Vendor</InputLabel>
                        <Select
                            labelId="demo-simple-select-label-vendor"
                            id="demo-simple-select-vendor"
                            // value={bearing_size}
                            label="Choose Vendor"
                            // onChange={handleChange}
                            >
                            <MenuItem value={"HCH"}>HCH</MenuItem>
                        </Select>
                    </FormControl>
